...
const handleGithubClick = (githubLink) => {
  if (githubLink === 'Private') {
    Swal.fire({
      ...
      text: 'source code Nahin Mil Sakta.',
...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    console.log('Project ID from URL:', id); // Debug: Log the ID
    window.scrollTo(0, 0);
    ...
    const fetchProject = async () => {
      ...
      try {
        ...
        if (!response.ok) {
          ...
          throw new Error(`Failed to fetch project: ${response.status} ${response.statusText} - ${errorText}`);
        }
        const data = await response.json();
        console.log('Fetched Project Data:', data); // Debug: Log fetched data
        const enhancedProject = {
          ...data,
          Features: data.Features || [],
          TechStack: data.TechStack || [],
          Github: data.Github || 'https://github.com/kyadaritarun',
        };
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                ...
                >
                  ...
                  <Github className="relative w-4 h-4 md:w-5 md:h-5 group-hover:rotate-12祉

System: transition-transform" />
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInRight">
              <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl group">
                ...
                <img
                  src={project.Img !== "#" ? project.Img : "/assets/images/placeholder.jpg"}
                  alt={project.Title}
                  className={`w-full object-cover transform transition-transform duration-700 will-change-transform group-hover:scale-105 ${!isImageLoaded ? 'hidden' : ''}`}
