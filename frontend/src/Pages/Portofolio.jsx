...
import { Code, Boxes, RefreshCw } from "lucide-react";
...
export default function FullWidthTabs() {
  ...
  const displayedProjects = showAllProjects ? projectList : projectList.slice(0, initialItems);
    ...
    <div className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] bg-[#030014] overflow-hidden" id="Portofolio">
      <div className="text-center pb-10" data-aos="fade-up" data-aos-duration="1000">
        ...
        <p className="text-slate-400 max-w-2xl mx-auto text-sm md:text-base mt-2">
          "Explore my journey through web projects and technical skills — each step reflecting my growth and dedication to building exceptional digital experiences."
        </p>
      </div>
        ...
        >
          <TabPanel value={value} index={0} dir={theme.direction}>
            <div className="container mx-auto flex justify-center items-center overflow-hidden">
              {isLoading && <div className="text-slate-300">Loading projects...</div>}
            ...
            {projectList.length > initialItems && (
