...
const WORDS = ["Frontend Technologies", "Backend Technologies"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/kyadaritarun" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/kyadari-tarun/" },
];
      ...
      >
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[0%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            {/* Left Column */}
            <div
              className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0 pl-4 sm:pl-6"
              data-aos="fade-right"
              data-aos-delay="200"
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <div
                  ...
                  data-aos-delay="800"
                >
                  <span className="text-xl md:text-2xl bg-gradient-to-r from-white via-blue-100 to-purple-200 bg-clip-text text-transparent font-light">
                    {text}
                  </span>
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                 Building Innovative, Functional, and User-Friendly Websites for Your Digital Needs.
                </p>
